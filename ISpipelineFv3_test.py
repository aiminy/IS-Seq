			...
			for barCodeline in barCodeFile:
				...
				if (lineSplitBrc[9]==sampleName):
					...
					if (os.path.isfile(r1filename) and os.path.isfile(r2filename)):
						...
						mycmd='''bwa mem -t 8 '''+dirGenome+''' '''+r1filename+ '''_ReadyToAlignSort ''' +r2filename+ '''_ReadyToAlignSort > ''' +os.path.join(alignOut,"R1_R2_Barcode_"+lineSplitBrc[7]+"_"+lineSplitBrc[8]+"_aligned_mem.sam")
						print mycmd
						process = subprocess.Popen(mycmd,shell=True)
						process.wait()
