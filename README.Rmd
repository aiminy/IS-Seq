...
In order to use INSPIIRED pipleine on our in-house generated data sets, we implemented a concise version of of INSPIIRED pipeline by re-using some codes in INSPIIRED pipeline. We used this concise version on both our in-house generated data sets and INSPIIRED data set.
